...
import { AlertContext as AlertContextInterface, AlertItem, AlertItemParams } from '@src/components/common/Alert/types';
...
export interface AlertProviderProps extends PropsWithChildren<any> {
